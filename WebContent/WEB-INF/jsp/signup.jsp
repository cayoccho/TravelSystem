                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page">
                                <div class="signup-header">
                                    ...
                                    <p>Đã có tài khoản? 
                                        <a href="dang-nhap" style="color: #ef5b92">Đăng nhập</a></p>
                                </div>
                                <label>Tên tài khoản
                                    <span class="color-red">*</span></label>
                                <input placeholder="Nhập tên tài khoản" class="form-control margin-bottom-20" type="text">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Mật Khẩu
                                            <span class="color-red">*</span>
                                        </label>
                                        <input placeholder="Nhập mật khẩu" class="form-control margin-bottom-20" type="password">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <label>Địa chỉ</label>
                                <input placeholder="Nhập địa chỉ" class="form-control margin-bottom-20" type="text">
                                <hr>
                                <div class="row">
                                    <div class="col-lg-8">
                                        <label class="checkbox">
                                            <input type="checkbox"> Tôi đồng ý với
                                            <a href="gioi-thieu" style="color: blueviolet;"> điều khoản và chính sách </a> của NY Travel Company
                                        </label>
                                    </div>
