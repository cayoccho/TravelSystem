<%-- 
    Document   : home
    Created on : Jan 08, 2017, 3:04:47 PM
            ...
            <div id="content">
                    ...
                    <div class="row">
                        ...
                        <div id="carousel-example" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <img src="img/slideshow/VinhHaLong.jpg">
                                </div>
                                <div class="item">
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Text -->
                        <div class="col-md-12">
                            <h2 class="text-center">Welcome to NY Travel Company</h2>
                        ...
                        <div class="col-md-10">
                            ...
                            <ul class="portfolio-group">
                                ...
                                <li class="portfolio-item col-sm-6 col-xs-6 padding-20">
                                    <a href="#">
                                        <figure class="animate fadeInLeft">
                                            <img alt="SaDecFlowerVillage" src="img/frontpage/SaDecFlowerVillage.jpg">
                                            <figcaption>
                                                <h3>Sa Dec Flower Village In Dong Thap Province</h3>
                                                <span>Tourists seem to be lost in a fairyland, full of colours and aromas of diverse flowers and plants, namely dahlia, hydrangeas, orchids, areca, wrightia religiosa, Hibiskus rosa-sinensis and African marigold. </span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                </li>
                                    ...
                                    <a href="#">
                                        <figure class="animate fadeInRight">
                                            ...
                                            <figcaption>
                                                ...
                                                <span>U Minh Ha National Park has typical feature of southern mangroves, trees in U Minh forest is mainly mangrove plants and vines with diverse fauna: freshwater fish, pangolins, wild boar, deer, monkeys, squirrels, snakes,...</span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                    ...
                                    <a href="#">
                                        <figure class="animate fadeInLeft">
                                            ...
                                            <figcaption>
                                                ...
                                                <span>Situated 6km to the northeast of the heart of the city of Da Lat, the Valley of Love has green pine forests on its beautiful hillsides, tourists are excited about a huge "magic faucet" lying in the air. </span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                    ...
                                    <a href="#">
                                        <figure class="animate fadeInRight">
                                            ...
                                            <figcaption>
                                                ...
                                                <span>Van Linh Pagoda is situated near a forest of acassia aneura and acacia trees covering 14,400m2. The most impressive features of this pagoda are the three towers before the front hall. </span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                    ...
                                    <a href="#">
                                        <figure class="animate fadeInLeft">
                                            ...
                                            <figcaption>
                                                ...
                                                <span>This is a place where has a the most beautiful beach in Vietnam. In place, you will see a long white sand, a deep blue sky and very hight coconut-palms. </span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
                                ...
                                <li class="portfolio-item col-sm-6 col-xs-6 padding-20">
                                    <a href="#">
                                        <figure class="animate fadeInRight">
                                            <img alt="CaiRangFloatingMarket" src="img/frontpage/CaiRangFloatingMarket.jpg">
                                            <figcaption>
                                                <h3>Cai Rang Floating Market In Can Tho City</h3>
                                                <span>This is the largest floating market in the Mekong Delta, starts around 05:00 and runs until around midday, meaning that you'll have to get an early start to the day if you want to visit. </span>
                                                <span style="color: hotpink; text-decoration: underline; font-weight: bold;"> Read more > </span>
                                            </figcaption>
                                        </figure>
                                    </a>
